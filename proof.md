...
Some alarm systems will log power events. Since the 90's here in the UK, some alarm systems namely [BT RedCare](https://en.wikipedia.org/wiki/Redcare) have used the telephone network to send signals back to a control centre and they work in much the same way as ADSL internet connections. This signal was an ideal way to test and monitor the UK's telephone network for realtime problems in the telephone network, like a cable down, but also to monitor the signal quality before ADSL was rolled out years later. And if you ever had the misfortune of being targeted by BT when your ADSL connection played up and they made you swap ADSL filter's and other time-wasting actions like resetting your router, this gives you an idea of how FTSE 100 stock market listed companies are just extension of the British Establishment, similar will deniability will exist in other countries!
