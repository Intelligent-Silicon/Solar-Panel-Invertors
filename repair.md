...
Some Hybrid Inverters even come with a small battery attached, but would you really want one of those in your loft, when we all know when the batteries overheat in Electrical Vehicles, the Fire Brigade cant put them out, they can only stop the fire from spreading until the batteries burn out. 
...
Anyone who has ever consumed gram amounts of the fat soluble Zinc Acetate DiHydrate to permanently disable the common cold (SARS aka Covid) viruses will be able to feel the electrical fields that leak out of unshielded cables which we witness as electrical interference. You can even tell your NHS GP this fact and they wont realise the increased amount of metals will increase the matrix metalloproteinases that break down your body, so why do we pay taxes for this level of incompetence in the UK? You wont even get PIP payments for this, even though its vastly more devastating than many of the things the DWP will pay out on! A classic example of abuse of power and Branding before Intelligence which makes a mockery of the British Legal system and some tests can only be performed posthumously in the test-tube (in vitro).

If you havent done this, but have put a 9v battery on your tongue and experienced a painful sensation, you will have experienced the mild directional current of DC voltage. Those who have tripped the RCD fusebox, holding onto 240V mains electrical cables (definitely not advised) to see how long the RCD mains fuse box really takes to trip, will know what AC feels like travelling through the body in its painful backwards and forwards wave-like motion as it heads to planet Earth...
...
However these solar panel inverters do have one main job, to convert DC into AC for the mains. Now as seen with the JLR new Defender, converting DC 12v into DC 48v and back again, is not easy, its not straight forward, so DC has to be converted into AC, do some other things to it before it can become DC 48V for the mild hybrid motors. If you are aware of how noise cancelling headphones work with sound waves, then electricity can be amplified or reduced using a similar concept. 

This process will always generate heat and losses will be incurred because that Heat is some of the original DC (12V). So meters will often measure one side of the process, either the DC coming in from the solar panels or the AC going to the mains. As UK regulations require a separate (Feed-In Tariff) meter to be fitted between the inverter and mains fuse box, this is to ensure manufacturers can not game their meter readings and make it look like they are returning more electricity to the grid than its really doing. These Feed-In Tariff meters are the independent check much like a referee or adjudicator. But its always good to know how much DC is coming from the solar panels and how much is leaving the inverter before it gets to the FIT meter because it can highlight problems with the solar panels and internal wiring.

Anyway this Youtube video shows you what the Varistors look like. 

It starts from 6:50 and shows you the two varistors in question. These are triple legged for temperature data, but cheaper two legged versions can be found online starting from as little as 8pence and would be used in small electrical gizmos & gadgets! They are cheap and disposable for the reason they are the sacrificial lambs to protect the main circuit board(s).

[![SMA HF](https://img.youtube.com/vi/svQkEsFzQag/0.jpg)](https://youtu.be/svQkEsFzQag?t=410)


The parts come in a kit, complete with a tool to release the clamps holding the legs of the varistor in place. 

There is one Crimped Leg so you put them in the correct way round and not backwards. 
...
What about warranties? Well, alot of the parts are designed for decades long use. The parts that break like the varistors are designed to be swapped out, but other components are designed for decades of long life provided the varistors do their job and protect from lightning strikes hitting the solar panels, or spikes coming from appliances in the property or national grid mains. In practice, there arent really any household devices which can take out an invertor on the mains side, but builders power tools in neighbouring properties can, as can industrial or old farm machinery in the locale. It could have been caused by someone having a car charger or battery installed, if it took out a neighborhood and wasnt deliberate... We will just never know!

And farmer's love buying their humongous gadgets that typically attach to tractors, using them for a season or two before leaving them lying around the farm to rust away, causing a localised environmental hazard, as their ADHD kicks in which doesnt exist according to Channel 4! And then we get told these farmers are poor whilst they knock around in their £100k plus tractors and SUV's lording it... Farms should have the same regulations applied to them as the one's Scrap Metal merchants have to comply with!

The capacitors usually fitted which help smooth the mostly tiny power fluctuations from the power source, are like fast acting Virtual Batteries. Most people will have heard of MOS-FET (Metal-Oxide-Semiconductor Field-Effect Transistor) found in high end HiFi amplifiers. So if the lifespan's of components are touted as so short like a 1000hour capacitor, why do second hand HiFi amps still sell for a premium decades later and still work extremely well? Has your hearing got worse with age so you dont hear how bad the sound has got?
...
The search continues... Or someone could just open up the Inverter safely and, peel off any sticky plaster-like material that might be obscuring the part number and get the partnumber that way. But who wants to go up inside a faeces covered loft because small birds have got inside and made it their home? You'd have to wear a breathing mask at least, because bird flu is spread through the faeces of birds and it can mutate into swine flu, both of which can easily infect humans... Is it any wonder that a common theme in society is the more knowledgable who are typically older, get to exploit the young, ruining them in some cases from such a young age, only for the individual to realise decades later what really went on, and the older more knowledgable person has long since died? What a toxic society we live in and its amazing how legal it is for people to commit crimes. How can these politicians claim to be educated enough to stand in parliament voting on legislation before something even gets to the House of Lords for a reading? Democracy is best explained as the blind leading the blind!
