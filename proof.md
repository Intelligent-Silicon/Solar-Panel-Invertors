...
Batteries from an APC Back-UPS RS 1500 BR1500LCDI [![APC Back-UPS RS 1500 BR1500LCDI](https://i.ebayimg.com/images/g/jDsAAOSw2QxcbBBK/s-l1600.jpg)](https://www.ebay.co.uk/itm/183693426403) costing today £10,193.94 on Ebay - just click the picture to see !!!
...
It should be noted that normally, Lithium ion battery's blow because gases build up as they age. The aging process can be vastly accelerated by letting the battery get hot, like keeping a mobile phone, laptop or tablet in the sun. The Lead Acid batteries used in desktop and server UPS (Uninterruptible Power Supplies) aka battery backups, can also suffer from this problem especially when the casing is sealed. The 3 factors that affect both lithium ion and lead acid are age, constant high temperatures and overcharging. In the case of the APC battery backup, capacitors or voltage regulation chips on the charging board can fail, causing the charger to supply continuous, unregulated high voltage to the battery causing them to fail. So its unlikely the mains electricity caused this problem, and without doing a tear down of the APC battery backup, checking the PCB components, its impossible to say for sure though.
...
Some alarm systems will log power events. Since the 90's here in the UK, some alarm systems namely [BT RedCare](https://en.wikipedia.org/wiki/Redcare) have used the telephone network to send signals back to a control centre and they work in much the same way as ADSL internet connections. This signal was an ideal way to test and monitor the UK's telephone network for realtime problems, like a telephone cable coming down in the wind because of a falling tree branch, vehicles crashing into the telegraph pole, or builders breaking cables, but it also provided the means to monitor the signal quality before ADSL was rolled out years later. And if you ever had the misfortune of being targeted by BT when your ADSL connection played up and they made you swap ADSL filter's and other time-wasting actions like resetting your router or experienced interruptions to business, like your telephone line simply not working which is an abuse of power the British Police, Press and muppet politicians including Prime Ministers simply have no idea of at best and complicit in the coverup if they do. It makes a mockery of countless FTSE 100 companies that may be genuine companies and not simply a tool of the British Military in plausibly deniable ways. 

It was in the 90's when I was at college studying A-levels that I was writing DOS software for businesses. One business I worked for gave me the keys to the premises and the alarm codes so I could write their software on-site when they had all gone home. One particular dark evening after setting the alarm & locking up, in the days before mobile phones were common place as I pulled off the industrial estate, I noticed a Police car, parked up on the side of the road some way away. I was travelling in the opposite direction so didnt think anything more of it, but that Police car broke the 30mph speed limit without blue lights on, to catch me up and pull me over to find out who I was. When I asked why I was being pulled over the Police officer told me there had been a break in on the industrial estate. So I promptly put him in his place by asking why hadnt I been told about this because we had expensive state of the art computer equipment on-site. This was the days of the 286, 386, before the 2hr free-serve dialup limit and were the only business on the industrial estate with computers at the time. As it happened there had not been any break-in, the Police officer lied simply to find out who I was because they could see the alarm being set late at night and didnt know who this was because the bosses were at home, no doubt using the phone and I was all on my own at work. After that the Police started driving onto the industrial estate in the evening just to spin round and see what businesses still had occupants because they could see into the offices without any difficulty. Sadly Authoritative What-Uppery is engrained in the DNA of the British Establishment and some large organisations that are too big too fail. I mean who does classism better than the British?

That company went from going bust to doubling its customer base in 6months because we used the BT Phonebase dialup system which gave us access to every telephone number in the UK, and used the dialling code and ```*engineer*``` to pull out every company with the word ```engineer``` in its name that had the specified dialling code in its number. Later when using the Natwest bank dialup computer system, I discovered payments and moving of money could be performed with no apparent checks provided the instructions were uploaded in the correct format within a short few second window, not using Natwest banks supplied software but Windows Terminal that shipped with Windows 3.1 and Windows for Workgroups!

If you think of a cable connection, like a network cable or telephone line or mains electrical cable, its capable of transmitting multiple signals down the wire. These signals are generally contained within the cable but more powerful ones can leak out of unshielded cables as electrical interference, but the concept of multiple radio signals down a wire are just like the different Radio Frequencies (Radio Stations) we can pick up with a radio, if you think of the air as one giant all encompassing cable. When you look at the different frequencies the ADSL router can pickup, its like a radio that can pick up and process multiple radio stations all at the same time! Which makes the router CPU's kind of interesting when looked at as a [Software Defined Radio. ](https://en.wikipedia.org/wiki/Software-defined_radio)

Here you can see bands of frequencies where data is uploaded or downloaded. Think of each band as an individual radio station, and your router is capable of transmitting and receiving simultaneously, in SDR terms, multiple full-duplex.
...
Collecting the data from all possible sources will help show there was a problem with the power whilst also showing the device may or may not have been at fault. Obviously not all device's will collect data, but increasingly more and more are and are often connected to data centre's online because they are an Internet of Things (IoT), providing its own little piece of meta data for the Security Services to build a picture before deciding to provide the anonymous CrimeStopper's tip off to the Police or blame the divorced wife, or disgruntled girlfriend rather than give away their true capabilities. The NHS is just as bad at acting as Judge, Jury and Executioner. Education/Staff Training makes people think they are doing good, so keep increasing your student loans for University education... Grooming starts young... Moving kids around to different countries, towns & cities because of employment reasons or to a different school is a normalised form of breaking down that trust the kid(s) will have, creating the circumstances for a lifetime of isolation. The abuse starts young but operates in plain sight, normalised by the unthinking in society.
