...
The manual also provides guidance on how to test the SMA inverter (Failure Search). Any competent person is capable of doing this if they can read and write AND follow instructions properly like a robot, because the manual tells you how to safely shutdown the inverter, break it apart and start it back up so there is no guess work. You just need the right tools because nobody wants this to happen....
